...
Como ya deberías saber, es muchísimo [más fácil crear nuevas paletas](https://rubenvara.io) de colores usando hsl(), y trabajar con este formato tiene muchas otra ventajas. Te lo cuento aquí.

</AlertBox>

<AlertBox type="announce" title="Deberías usar HSL">

Como ya deberías saber, es muchísimo [más fácil crear nuevas paletas](https://rubenvara.io) de colores usando hsl(), y trabajar con este formato tiene muchas otra ventajas. Te lo cuento aquí.

</AlertBox>

<AlertBox type="note" title="Deberías usar HSL">

Como ya deberías saber, es muchísimo [más fácil crear nuevas paletas](https://rubenvara.io) de colores usando hsl(), y trabajar con este formato tiene muchas otra ventajas. Te lo cuento aquí.

</AlertBox>

<AlertBox type="warning" title="Deberías usar HSL">

Como ya deberías saber, es muchísimo [más fácil crear nuevas paletas](https://rubenvara.io) de colores usando hsl(), y trabajar con este formato tiene muchas otra ventajas. Te lo cuento aquí.

</AlertBox>

<AlertBox type="danger" title="Deberías usar HSL">

Como ya deberías saber, es muchísimo [más fácil crear nuevas paletas](https://rubenvara.io) de colores usando hsl(), y trabajar con este formato tiene muchas otra ventajas. Te lo cuento aquí.

</AlertBox>

<AlertBox title="Deberías usar HSL">
