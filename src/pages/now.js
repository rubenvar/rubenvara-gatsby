...
const Now = () => (
  <>
    <SEO title="Esto es lo que estoy haciendo ahora!" />
    ...
    <p>
      Además, seguir tratando de mejorar, física y mentalmente. Ahora trabajando
      con Kettlebells.
    </p>
    ...
    <p>
      Esto es una página _now_ ([explicación aquí](http://nownownow.com/about)).
